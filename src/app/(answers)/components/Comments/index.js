...
const Comments = () => {
  return (
    <div className="w-full relative">
      ...
      {/* container */}
      <div className="w-full relative flex flex-col bg-[#FAFAFB] p-xl rounded-md">
        {/* comment group */}
        <div className="w-full relative">
          <div className="w-full relative flex flex-col pb-xl last:pb-[0] pl-[40px] first:pl-[0] group">
            <span className="w-[20px] translate-x-[10px] mb-[24px] absolute after:w-[3px] after:h-[40px] after:bg-[#D8D0DD] after:left-[-3px] after:absolute after:top-[-40px] border-l-[3px] h-[calc(100%-25px)] rounded-bl-[15px]  border-l-[#D8D0DD] border-b-[3px] border-b-[#D8D0DD] flex bottom-[-40px] left-[0] group-first:after:hidden group-last:hidden"></span>
            <Avatar />
