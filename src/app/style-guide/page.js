  ...
  return (
    <div className="w-full py-lg">
      <div className="container">
        <h1 className="text-xl text-center mx-auto bg-primary-grey border border-secondary-border px-xl py-lg mb-xl">
          This is an ambitious project by{" "}
          ...
          <div className="w-auto flex flex-wrap">
            ...
            <div className="w-9/12">
              <div className="w-full flex flex-col pl-2xl">
                <h4 className="text-2xl font-medium mb-xs">Colors</h4>
                <p className="text-md max-w-[800px] opacity-70">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Eaque quos quam nulla accusamus ducimus voluptate facilis
                  atque, tempore sint nemo tempora omnis beatae aut, dolore
                  consequatur, nihil quo! Iure, nesciunt!
                </p>
              </div>
